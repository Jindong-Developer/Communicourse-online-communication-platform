...
Ext
		.apply(
				Ext.EventManager,
				function() {
					var c, k, e, b, a = Ext.lib.Dom, j = /^(?:scope|delay|buffer|single|stopEvent|preventDefault|stopPropagation|normalized|args|delegate)$/, h = 0, g = 0, d = Ext.isWebKit ? Ext
							.num(navigator.userAgent
									.match(/AppleWebKit\/(\d+)/)[1]) >= 525
					...
					return {
						...
						onWindowResize : function(n, m, l) {
							if (!c) {
								...
								Ext.EventManager.on(window, "resize",
...
(function() {
	...
	h.prototype = {
		...
		contains : function(p) {
			return !p ? false : Ext.lib.Dom.isAncestor(this.dom, p.dom ? p.dom
					: p)
		},
		...
		.addMethods( {
			getAnchorXY : function(e, m, t) {
				...
				var l = this, b = l.dom == document.body || l.dom == document, p = t.width
						...
						.getXY(), n = l.getScroll(), k = b ? n.left : !m ? c[0]
						: 0, g = b ? n.top : !m ? c[1] : 0, d = {
					c : [ a(p * 0.5), a(j * 0.5) ],
					t : [ a(p * 0.5), 0 ],
					l : [ 0, a(j * 0.5) ],
					r : [ p, a(j * 0.5) ],
			...
			getAlignToXY : function(g, B, C) {
				...
				C = C || [ 0, 0 ];
				B = (!B || B == "?" ? "tl-bl?"
						: (!/-/.test(B) && B !== "" ? "tl-" + B : B || "tl-bl"))
						.toLowerCase();
				var L = this, I = L.dom, N, M, q, n, t, G, z, u = Ext.lib.Dom
						.getViewWidth() - 10, H = Ext.lib.Dom.getViewHeight() - 10, b, j, k, l, v, A, O = document, K = O.documentElement, s = O.body, F = (K.scrollLeft
						|| s.scrollLeft || 0) + 5, E = (K.scrollTop
						|| s.scrollTop || 0) + 5, J = false, e = "", a = "", D = B
						.match(/^([a-z]+)-([a-z]+)(\?)?$/);
				if (!D) {
...
Ext.Element.addMethods(function() {
	...
	return {
		...
		createChild : function(e, d, g) {
			...
			return d ? b.insertBefore(d, e, g !== true)
...
Ext.apply(Ext.Element.prototype, function() {
	...
	return {
		insertSibling : function(j, g, h) {
			...
			j = j || {};
			if (j.nodeType || j.dom) {
				e = k.dom.parentNode.insertBefore(c(j), d ? k.dom.nextSibling
						: k.dom);
				if (!h) {
					e = a(e)
				}
				...
				if (d && !k.dom.nextSibling) {
					...
					e = b[d ? "insertAfter" : "insertBefore"](k.dom, j, !h)
				}
			}
			return e
		}
			...
			return {
				...
				removeClass : function(I) {
					...
					if (J.dom && J.dom.className) {
						for ( var H = 0, F = I.length; H < F; H++) {
							G = I[H];
							if (G) {
								J.dom.className = J.dom.className.replace(
										b[G] = b[G]
												|| new RegExp("(?:^|\\s+)" + G
														+ "(?:\\s+|$)", "g"),
										" ")
				...
				getHeight : function(H) {
					var G = this, J = G.dom, I = Ext.isIE
							&& G.isStyle("display", "none"), F = s.max(
							J.offsetHeight, I ? 0 : J.clientHeight) || 0;
				...
				getWidth : function(G) {
					var H = this, J = H.dom, I = Ext.isIE
							&& H.isStyle("display", "none"), F = s.max(
							J.offsetWidth, I ? 0 : J.clientWidth) || 0;
...
Ext.Element
		.addMethods(function() {
			...
			return {
				...
				boxWrap : function(c) {
					c = c || "x-box";
					var d = Ext.get(this.insertHtml("beforeBegin",
							"<div class='" + c + "'>"
				...
				getComputedHeight : function() {
					var d = this, c = Math.max(d.dom.offsetHeight,
							d.dom.clientHeight);
					if (!c) {
				...
				getFrameWidth : function(d, c) {
					return c && this.isBorderBox() ? 0
							: (this.getPadding(d) + this.getBorderWidth(d))
				},
...
(function() {
	...
	Ext.Element.addMethods( {
		...
		setX : function(m, n) {
			return this.setXY( [ m, this.getY() ], this.animTest(arguments, n,
					1))
		},
		setY : function(n, m) {
			return this.setXY( [ this.getX(), n ], this.animTest(arguments, m,
					1))
		},
		setLeft : function(m) {
		...
		.addMethods( {
			...
			scrollIntoView : function(e, j) {
				var q = Ext.getDom(e) || Ext.getBody().dom, h = this.dom, g = this
						...
						+ h.offsetWidth, a = q.clientHeight, n = parseInt(
						q.scrollTop, 10), u = parseInt(q.scrollLeft, 10), k = n
						+ a, p = u + q.clientWidth;
			...
			scroll : function(n, b, d) {
				...
				if ((p = k[n]) > -1) {
					c = true;
					this.scrollTo(n == "l" || n == "r" ? "left" : "top", p,
		...
		.addMethods(function() {
			...
			return {
				...
				anim : function(p, q, n, s, o, m) {
					n = n || "run";
					q = q || {};
					var r = this, t = Ext.lib.Anim[n](r.dom, p,
							(q.duration || s) || 0.35, (q.easing || o)
									|| "easeOut", function() {
								if (m) {
									m.call(r)
								}
...
Ext.Element
		.addMethods(function() {
			...
			return {
				...
				unmask : function() {
					var l = this, m = l.dom, j = e(m, "mask"), k = e(m,
							"maskMsg");
					if (j) {
						if (k) {
							k.remove();
	...
	Ext.Fx = {
					...
					function() {
						...
						J = q(H)
								.switchStatements(
										...
										R,
										{
											t : [ E, N, M.width, 0, z, z, o, m,
													z, G, z ],
											l : [ E, N, 0, M.height, z, z, n,
													t, L, z, z ],
											r : [ E, N, M.width, M.height, k,
													M.right, o, t, z, z, O ],
											b : [ E, N, M.width, M.height, h,
													M.bottom, o, t, z, G, O ],
											tl : [ E, N, 0, 0, z, z, n, m, L,
													G, O ],
											bl : [ E, N, 0, 0, h,
													M.y + M.height, n, t, L, G,
													O ],
											br : [ E, N, 0, 0, a,
													[ M.right, M.bottom ], o,
													t, L, G, O ],
		...
		highlight : function(E, I) {
			...
			G.queueFx(I, function() {
				...
				arguments.callee.anim = q(H).fxanim(D, I, "color", 1, "easeIn",
						J)
			});
			return G
		},
			...
			.extend(
					...
					Ext.util.Observable,
					{
						...
						request : function(q) {
							...
							if (t.fireEvent(b, t, q)) {
								if (q.el) {
									...
									q.success = (Ext.isFunction(q.success) ? q.success
											: function() {
											})
								...
								m = Ext.urlEncode(t.extraParams, Ext
										.isObject(m) ? Ext.urlEncode(m) : m);
								if (Ext.isFunction(l)) {
								...
								k = q.method
										|| t.method
										|| ((m || q.xmlData || q.jsonData) ? j
												: a);
								if (k === a
										&& (t.disableCaching && q.disableCaching !== false)
										|| q.disableCaching === true) {
									var s = q.disableCachingParam
											|| t.disableCachingParam;
									l = Ext.urlAppend(l, s + "="
											+ (new Date().getTime()))
								}
								q.headers = Ext.apply(q.headers || {},
										t.defaultHeaders || {});
								...
								return (t.transId = Ext.lib.Ajax.request(k, l,
										r, m, q))
							} else {
								return q.callback ? q.callback.apply(q.scope, [
										q, h, h ]) : null
							}
						},
						isLoading : function(k) {
							return k ? Ext.lib.Ajax.isCallInProgress(k)
									: !!this.transId
						},
						abort : function(k) {
							if (k || this.isLoading()) {
						...
						doFormUpload : function(r, k, l) {
							var m = Ext.id(), w = document, s = w
									.createElement("iframe"), n = Ext
							...
							Ext.iterate(Ext.urlDecode(k, false),
									function(x, o) {
							...
							function t() {
								...
								try {
									B = s.contentWindow.document
											|| s.contentDocument
											|| g.frames[m].document;
									if (B) {
										if (B.body) {
											if (/textarea/i
													.test((A = B.body.firstChild
															|| {}).tagName)) {
	...
	function g(h, j, k) {
		...
		if (Ext.isFunction(h.argument.callback)) {
			h.argument.callback.call(h.argument.scope, this.el,
					Ext.isEmpty(k) ? true : false, h, h.argument.options)
		}
	}
	function e(h) {
	...
	return {
		...
		usMoney : function(v) {
			...
			v = (v == Math.floor(v)) ? v + ".00" : ((v * 10 == Math
					.floor(v * 10)) ? v + "0" : v);
			v = String(v);
			var ps = v.split("."), whole = ps[0], sub = ps[1] ? "." + ps[1]
					: ".00", r = /(\d+)(\d{3})/;
			while (r.test(whole)) {
				...
				Ext.util.Observable,
				{
					...
					update : function(b, d, a) {
						...
						if (this.tpl && typeof b !== "string") {
							...
							var e = Ext.isObject(b) ? Ext.DomHelper.markup(b)
									: b;
							c.update(e, d, a)
						}
					},
					...
					onShow : function() {
						this.getVisibilityEl().removeClass(
								"x-hide-" + this.hideMode)
					},
					hide : function() {
					...
					isVisible : function() {
						return this.rendered
								&& this.getVisibilityEl().isVisible()
					},
					...
					Ext.Element,
					{
						...
						constrainXY : function() {
							if (this.constrain) {
								...
								var m = this.dom.offsetWidth + c, e = this.dom.offsetHeight
										+ c;
								var g = false;
								if ((l + m) > k + p.left) {
									l = k - m - c;
...
Ext.layout.ContainerLayout = Ext
		.extend(
				Object,
				{
					monitorResize : false,
					...
					layout : function() {
						...
						this.container.fireEvent("afterlayout", this.container,
								this);
						this.hasLayout = true
					},
					...
					isValidParent : function(b, a) {
						return a
								&& b.getPositionEl().dom.parentNode == (a.dom || a)
					},
					...
					renderItem : function(d, a, b) {
						if (d && !d.rendered) {
							...
							if (d && !this.isValidParent(d, b)) {
								...
								b.dom.insertBefore(d.getPositionEl().dom, a
										|| null);
								d.container = b;
								this.configureItem(d, a)
							}
							...
							if (!c.hasLayoutPending()) {
								if (!this.resizeTask) {
									this.resizeTask = new Ext.util.DelayedTask(
											this.runLayout, this);
									this.resizeBuffer = Ext.isNumber(a) ? a
											: 50
								}
...
Ext.layout.CardLayout = Ext.extend(Ext.layout.FitLayout, {
	...
	setActiveItem : function(c) {
		...
		if (a != c) {
			...
			var b = c.doLayout && (this.layoutOnCardChange || !c.rendered);
			this.activeItem = c;
			if (c) {
				c.show()
			}
...
Ext.layout.AnchorLayout = Ext.extend(Ext.layout.ContainerLayout, {
	...
	getAnchorViewSize : function(a, b) {
		return b.dom == document.body ? b.getViewSize(true) : b.getStyleSize()
	},
...
Ext.layout.ColumnLayout = Ext.extend(Ext.layout.ContainerLayout, {
	...
	onLayout : function(d, j) {
		...
		for (a = 0; a < g; a++) {
			k = e[a];
			if (!k.columnWidth) {
				m -= (k.getSize().width + k.getPositionEl().getMargins("lr"))
			}
		}
		m = m < 0 ? 0 : m;
		for (a = 0; a < g; a++) {
		...
		.extend(
				Ext.layout.AnchorLayout,
				{
					...
					onRemove : function(d) {
						...
						var b = d.getPositionEl(), a = d.getItemCt
								&& d.getItemCt();
						if (d.rendered && a) {
							if (b && b.dom) {
								b.insertAfter(a)
							...
							if (d.customItemCt) {
								Ext.destroyMembers(d, "getItemCt",
										"customItemCt")
							}
						}
					},
					setContainer : function(a) {
						...
						if (a.hideLabels) {
							...
							if (Ext.isNumber(a.labelWidth)) {
								var b = Ext.isNumber(a.labelPad) ? a.labelPad
										: 5;
								Ext.apply(this, {
					...
					renderItem : function(e, a, d) {
						if (e && (e.isFormField || e.fieldLabel)
								&& e.inputType != "hidden") {
							...
							if (a) {
								e.itemCt = this.fieldTpl.insertBefore(a, b,
										true)
							} else {
					...
					getTemplateArgs : function(b) {
						...
						return {
							...
							labelSeparator : a ? ""
									: (Ext.isDefined(b.labelSeparator) ? b.labelSeparator
											: this.labelSeparator),
					...
					adjustWidthAnchor : function(a, d) {
						if (d.label && !this.isHide(d)
								&& (this.container.labelAlign != "top")) {
...
Ext.layout.BoxLayout = Ext.extend(Ext.layout.ContainerLayout, {
	...
	getTargetSize : function(a) {
		return (Ext.isIE6 && Ext.isStrict && a.dom == document.body) ? a
				.getStyleSize() : a.getViewSize(true)
	},
	getItems : function(b) {
		var a = [];
		...
		.extend(
				Ext.layout.BoxLayout,
				{
					...
					onLayout : function(g, K) {
						Ext.layout.VBoxLayout.superclass.onLayout.call(this, g,
								K);
						var j = this.getItems(g), n, r, y, o, u, q, z = K
								.getViewSize(true), p = z.width, D = z.height
						...
						var b = Math.max(0, p - this.padding.left
								- this.padding.right);
						for (i = 0; i < k; i++) {
							H = j[i];
							n = H.margins;
							if (this.align == "stretch") {
								H
										.setWidth((G - (n.left + n.right))
												.constrain(H.minWidth || 0,
														H.maxWidth || 1000000))
							} else {
								if (this.align == "stretchmax") {
									H.setWidth((F - (n.left + n.right))
											.constrain(H.minWidth || 0,
													H.maxWidth || 1000000))
								} else {
									if (m && H.flex) {
						...
						var d = Math.max(0, D - this.padding.top
								- this.padding.bottom - I), J = d;
						for (i = 0; i < k; i++) {
							H = j[i];
							if (m && H.flex) {
				...
				Ext.layout.BoxLayout,
				{
					...
					onLayout : function(d, H) {
						Ext.layout.HBoxLayout.superclass.onLayout.call(this, d,
								H);
						var e = this.getItems(d), k, c, u, p, r, v = H
								.getViewSize(true), n = v.width
						...
						var A = Math.max(0, n - this.padding.left
								- this.padding.right - b), G = A, m = [], D = [], s = 0, a = Math
								.max(0, E - this.padding.top
										- this.padding.bottom);
						Ext.each(e, function(h) {
							if (j && h.flex) {
						...
						Ext.each(e, function(h) {
							...
							if (this.align == "stretch") {
								...
								if (this.align == "stretchmax") {
									h.setHeight((x - (k.top + k.bottom))
											.constrain(h.minHeight || 0,
													h.maxHeight || 1000000))
								} else {
		...
		.extend(
				Ext.Container,
				{
					...
					createToolbar : function(b, c) {
						...
						a = b.events ? Ext.apply(b, c) : this.createComponent(
								Ext.apply( {}, b, c), "toolbar");
						a.ownerCt = this;
					...
					onRender : function(g, e) {
						...
						if (this.frame) {
							...
							this.createElement("header",
									h.firstChild.firstChild.firstChild);
							...
							this.createElement("footer",
									l.lastChild.firstChild.firstChild);
							if (!this.footer) {
						...
						if (this.collapsible && this.titleCollapse
								&& this.header) {
							this.mon(this.header, "click", this.toggleCollapse,
									this);
					...
					makeFloating : function(a) {
						...
						this.el = new Ext.Layer(Ext.apply( {}, a, {
							shadow : Ext.isDefined(this.shadow) ? this.shadow
									: "sides",
					...
					syncHeight : function() {
						...
						if (b != this.getToolbarHeight()) {
							b = Math.max(0, this.adjustBodyHeight(a
									- this.getFrameHeight()));
							c.setHeight(b);
							d = c.getSize();
						...
						if (Ext.isDefined(a) || Ext.isDefined(b)) {
							if (!this.collapsed) {
								...
								if (this.footer) {
									...
									if (this.fbar) {
										this.fbar
												.setSize(Ext.isIE ? (a - this.footer
														.getFrameWidth("lr"))
														: "auto")
									}
								}
					...
					getFrameHeight : function() {
						...
						if (this.frame) {
							a += this.el.dom.firstChild.offsetHeight
					...
					beforeDestroy : function() {
						...
						if (this.rendered) {
							Ext.destroy(this.ft, this.header, this.footer,
									this.toolbars, this.tbar, this.bbar,
									this.body, this.mc, this.bwrap);
							if (this.fbar) {
		...
		.extend(Ext.Editor, Ext.Component,
				{
					...
					doAutoSize : function() {
						if (this.autoSize) {
							var b = this.boundEl.getSize(), a = this.field
									.getSize();
		...
		.extend(
				Ext.BoxComponent,
				{
					...
					initComponent : function() {
						...
						this.value = this.value ? this.value.clearTime(true)
								: new Date().clearTime();
						this.addEvents("select");
						if (this.handler) {
					...
					update : function(H, B) {
						if (this.rendered) {
							...
							var k = H.getDaysInMonth(), q = H
									.getFirstDateOfMonth(), g = q.getDay()
									- this.startDay;
							if (g < 0) {
								g += 7
							}
							...
							var C = H.add("mo", -1), h = C.getDaysInMonth() - g, e = this.cells.elements, r = this.textNodes, z = 86400000, E = (new Date(
									C.getFullYear(), C.getMonth(), h))
									.clearTime(), D = new Date().clearTime()
									.getTime(), v = H.clearTime(true).getTime(), u = this.minDate ? this.minDate
									.clearTime(true)
									: Number.NEGATIVE_INFINITY, y = this.maxDate ? this.maxDate
									.clearTime(true)
									: Number.POSITIVE_INFINITY, G = this.disabledDatesRE, s = this.disabledDatesText, J = this.disabledDays ? this.disabledDays
									.join("")
									: false, F = this.disabledDaysText, A = this.format;
							if (this.showToday) {
								var m = new Date().clearTime(), c = (m < u
										|| m > y
										|| (G && A && G.test(m.dateFormat(A))) || (J && J
										.indexOf(m.getDay()) != -1));
								if (!this.disabled) {
									this.todayBtn.setDisabled(c);
									this.todayKeyListener[c ? "disable"
											: "enable"]()
								}
							}
							var l = function(L, d) {
					...
					beforeDestroy : function() {
						if (this.rendered) {
							Ext.destroy(this.keyNav, this.monthPicker,
									this.eventEl, this.mbtn, this.nextRepeater,
									this.prevRepeater, this.cells.el,
									this.todayBtn);
...
Ext.Slider = Ext
		.extend(
				Ext.BoxComponent,
				{
					...
					getRatio : function() {
						var a = this.innerEl.getWidth(), b = this.maxValue
								- this.minValue;
						return b == 0 ? a : (a / b)
					},
					...
					beforeDestroy : function() {
						Ext.destroyMembers(this, "endEl", "innerEl", "thumb",
								"halfThumb", "focusEl", "tracker",
								"thumbHolder");
...
Ext.dd.DragTracker = Ext.extend(Ext.util.Observable, {
	...
	constructor : function(a) {
		Ext.apply(this, a);
		this.addEvents("mousedown", "mouseup", "mousemove", "dragstart",
				"dragend", "drag");
...
Ext.dd.ScrollManager = function() {
	...
	var d = function() {
		if (c.dragCurrent) {
			...
			var n = j.el.ddScrollConfig ? j.el.ddScrollConfig.increment
					: m.increment;
			if (!m.animate) {
		...
		prepare : function(b) {
			...
			for ( var d in this.actions) {
				...
				if (typeof (b.api[c]) == "string") {
					b.api[c] = {
						url : b.api[c],
						method : (b.restful === true) ? Ext.data.Api.restActions[c]
								: undefined
					}
				}
			}
		...
		restify : function(b) {
			...
			b.onWrite = b.onWrite.createInterceptor(function(j, k, g, e) {
				...
				if (h.success === true) {
					...
					this.fireEvent("exception", this, "remote", j, k, h, e)
				}
...
Ext.data.DataReader.prototype = {
	...
	isData : function(a) {
		return (a && Ext.isObject(a) && !Ext.isEmpty(this.getId(a))) ? true
				: false
	},
	onMetaChange : function(a) {
		delete this.ef;
...
Ext.data.DataWriter.prototype = {
	...
	toHash : function(g, c) {
		var e = g.fields.map, d = {}, b = (this.writeAllFields === false && g.phantom === false) ? g
				.getChanges()
				: g.data, a;
...
Ext.extend(Ext.data.DataProxy, Ext.util.Observable, {
	...
	buildUrl : function(d, b) {
		b = b || null;
		var c = (this.conn && this.conn.url) ? this.conn.url
...
Ext.extend(Ext.data.HttpProxy, Ext.data.DataProxy, {
	...
	onWrite : function(g, j, c, b) {
		...
		try {
			...
			j.request.callback
					.call(j.request.scope, null, j.request.arg, false);
			return
		}
		if (d.success === false) {
			this.fireEvent("exception", this, "remote", g, j, d, b)
		} else {
			this.fireEvent("write", this, g, d.data, d, b, j.request.arg)
		}
		...
		.extend(
				...
				Ext.data.DataReader,
				{
					...
					readResponse : function(e, b) {
						var g = (b.responseText !== undefined) ? Ext
								.decode(b.responseText) : b;
						if (!g) {
					...
					buildExtractors : function() {
						...
						if (l.totalProperty) {
							this.getTotal = this
									.createAccessor(l.totalProperty)
						}
						if (l.successProperty) {
							this.getSuccess = this
									.createAccessor(l.successProperty)
						}
						if (l.messageProperty) {
							this.getMessage = this
									.createAccessor(l.messageProperty)
						}
						this.getRoot = l.root ? this.createAccessor(l.root)
								: function(g) {
									return g
								};
					...
					render : function(b, c, a) {
						...
						b.xmlData = this.tpl
								.applyTemplate( {
									...
									documentRoot : (c.length > 0 || this.forceDocumentRoot === true) ? this.documentRoot
											: false,
		...
		.extend(
				...
				Ext.data.DataReader,
				{
					...
					readRecords : function(d) {
						...
						var b = this.extractData(c.select(this.meta.record, a),
								true);
						return {
							success : e,
							records : b,
					...
					readResponse : function(e, a) {
						...
						var b = new Ext.data.Response( {
							...
							success : this.getSuccess(g),
							message : this.getMessage(g),
							data : this.extractData(d.select(this.meta.record,
									g)
					...
					buildExtractors : function() {
						...
						this.getRoot = function(g) {
							return (!Ext.isEmpty(g[this.meta.record])) ? g[this.meta.record]
									: g[this.meta.root]
						};
						if (l.idPath || l.idProperty) {
							var d = this.createAccessor(l.idPath
									|| l.idProperty);
				...
				Ext.direct.JsonProvider,
				{
					...
					doSend : function(d) {
						...
						if (this.enableUrlEncode) {
							var e = {};
							e[Ext.isString(this.enableUrlEncode) ? this.enableUrlEncode
									: "data"] = Ext.encode(b);
							g.params = e
						} else {
							g.jsonData = b
					...
					queueTransaction : function(a) {
						...
						if (this.enableBuffer) {
							...
							this.callTask
									.delay(Ext.isNumber(this.enableBuffer) ? this.enableBuffer
											: 10)
						} else {
							this.combineAndSend()
						}
					...
					doForm : function(k, b, g, j, e) {
						var d = new Ext.Direct.Transaction( {
							...
							method : b.name,
							args : [ g, j, e ],
							cb : e && Ext.isFunction(j) ? j.createDelegate(e)
									: j,
							isForm : true
						});
						if (this.fireEvent("beforecall", this, d) !== false) {
							...
							Ext.apply(d, {
								form : Ext.getDom(g),
								isUpload : a,
								params : j && Ext.isObject(j.params) ? Ext
										.apply(h, j.params) : h
							});
							this.fireEvent("call", this, d);
							this.processForm(d)
					...
					doCallback : function(c, g) {
						...
						if (c && c.cb) {
							var b = c.cb, a = Ext.isDefined(g.result) ? g.result
									: g.data;
							if (Ext.isFunction(b)) {
								b(a, g)
							} else {
						...
						if (this.enabled && this.activeHandle) {
							try {
								...
								var u = this.curSize || this.startBox, m = this.startBox.x, l = this.startBox.y, c = m, b = l, n = u.width, v = u.height, d = n, p = v, o = this.minWidth, B = this.minHeight, t = this.maxWidth, E = this.maxHeight, j = this.widthIncrement, a = this.heightIncrement, C = A
										.getXY(), s = -(this.startPoint[0] - Math
										.max(this.minX, C[0])), q = -(this.startPoint[1] - Math
										.max(this.minY, C[1])), k = this.activeHandle.position, F, g;
								switch (k) {
								case "east":
									n += s;
...
Ext.MessageBox = function() {
	var v, b, r, u, h, m, t, a, o, q, k, g, s, w, p, j = "", d = "", n = [
			"ok", "yes", "no", "cancel" ];
	var c = function(y) {
		s[y].blur();
		if (v.isVisible()) {
		...
		show : function(B) {
			...
			if (b.prompt) {
				if (b.multiline) {
					t.hide();
					a.show();
					a.setHeight(Ext.isNumber(b.multiline) ? b.multiline
				...
				Ext.DataView,
				{
					...
					initComponent : function() {
						if (this.columnResize) {
							this.colResizer = new Ext.list.ColumnResizer(
									this.colResizer);
							this.colResizer.init(this)
						}
						if (this.columnSort) {
							this.colSorter = new Ext.list.Sorter(
									this.columnSort);
						...
						for ( var g = 0; g < m; g++) {
							var n = l[g];
							if (!n.isColumn) {
								n.xtype = n.xtype ? (/^lv/.test(n.xtype) ? n.xtype
										: "lv" + n.xtype)
										: "lvcolumn";
								n = Ext.create(n)
							}
					...
					onRender : function() {
						...
						Ext.list.ListView.superclass.onRender.apply(this,
								arguments);
					...
					collectData : function() {
						var a = Ext.list.ListView.superclass.collectData.apply(
								this, arguments);
						return {
							columns : this.columns,
							rows : a
					...
					updateIndexes : function() {
						Ext.list.ListView.superclass.updateIndexes.apply(this,
								arguments);
		...
		.extend(
				Ext.list.Column,
				{
					...
					constructor : function(e) {
						...
						Ext.list.DateColumn.superclass.constructor
								.call(this, e)
					}
				});
Ext.reg("lvbooleancolumn", Ext.list.BooleanColumn);
Ext.list.ColumnResizer = Ext
		.extend(
				Ext.util.Observable,
				{
					minPct : 0.05,
					constructor : function(a) {
						Ext.apply(this, a);
						Ext.list.ColumnResizer.superclass.constructor
								.call(this)
					},
					init : function(a) {
						this.view = a;
					...
					handleHdMove : function(k, g) {
						var b = 5, a = k.getPageX(), j = k.getTarget("em", 3,
								true);
						if (j) {
					...
					onStart : function(c) {
						...
						var a = this.tracker.getXY()[0], b = this.view.innerHd
								.getWidth();
					...
					onEnd : function(l) {
						...
						var h = this.hdIndex, o = this.view, g = o.columns, k = g.length, q = this.view.innerHd
								...
								.ceil((j * o.maxWidth) / q), p = (g[h].width * 100)
								- r, n = Math.floor(p / (k - 1 - h)), m = p
								- (n * (k - 1 - h));
						for ( var c = h + 1; c < k; c++) {
		...
		.extend(
				Ext.Panel,
				{
					...
					initTab : function(d, b) {
						var e = this.strip.dom.childNodes[b], g = this
								.getTemplateArgs(d), c = e ? this.itemTpl
								.insertBefore(e, g) : this.itemTpl.append(
								this.strip, g), a = "x-tab-strip-over", h = Ext
								.get(c);
						h.hover(function() {
							if (!d.disabled) {
								h.addClass(a)
					...
					onItemIconChanged : function(d, a, c) {
						...
						if (b) {
							...
							b[Ext.isEmpty(a) ? "removeClass" : "addClass"]
									("x-tab-with-icon")
						}
					},
					getTabEl : function(a) {
					...
					autoSizeTabs : function() {
						var h = this.items.length, b = this.tabPosition != "bottom" ? "header"
						...
						for ( var e = 0, j = m.length; e < j; e++) {
							var l = m[e], n = Ext.fly(l).child(
									".x-tab-strip-inner", true), g = l.offsetWidth, d = n.offsetWidth;
					...
					setActiveTab : function(c) {
						...
						if (this.fireEvent("beforetabchange", this, c,
					...
					autoScrollTabs : function() {
						...
						var h = this.items.length, d = this.pos.dom.offsetWidth, c = this.pos.dom.clientWidth, g = this.stripWrap, e = g.dom, b = e.offsetWidth, j = this
								.getScrollPos(), a = this.edge
								.getOffsetsTo(this.stripWrap)[0]
								+ j;
					...
					scrollToTab : function(e, a) {
						...
						var c = this.getTabEl(e), h = this.getScrollPos(), d = this
								.getScrollArea(), g = Ext.fly(c).getOffsetsTo(
								this.stripWrap)[0]
								+ h, b = g + c.offsetWidth;
						if (g < h) {
							this.scrollTo(g, a)
					...
					onWheel : function(g) {
						...
						g.stopEvent();
						var j = this.getScrollPos(), c = j + h, a = this
								.getScrollWidth()
								- this.getScrollArea();
					...
					beforeDestroy : function() {
						...
						this.deleteMembers("strip", "edge", "scrollLeft",
								"scrollRight", "stripWrap");
						this.activeTab = null;
				...
				Ext.BoxComponent,
				{
					...
					getTemplateArgs : function() {
						return [
								...
								this.getMenuClass(), this.cls, this.id ]
					},
					setButtonClass : function() {
						if (this.useSetClass) {
							...
							this.oldCls = (this.iconCls || this.icon) ? (this.text ? " x-btn-text-icon"
									: " x-btn-icon")
									: " x-btn-noicon";
		...
		.extend(
				Ext.Button,
				{
					...
					isMenuTriggerOver : function(a) {
						return this.menu
								&& a.target.tagName == this.arrowSelector
					},
					isMenuTriggerOut : function(b, a) {
						return this.menu
								&& b.target.tagName != this.arrowSelector
					}
				});
...
Ext.layout.ToolbarLayout = Ext
		.extend(
				Ext.layout.ContainerLayout,
				{
					...
					onLayout : function(d, h) {
						if (!this.leftTr) {
							var g = d.buttonAlign == "center" ? "center"
									: "left";
							h.addClass("x-toolbar-layout-ct");
							h
									.insertHtml(
											"beforeEnd",
											'<table cellspacing="0" class="x-toolbar-ct"><tbody><tr><td class="x-toolbar-left" align="' + g + '"><table cellspacing="0"><tbody><tr class="x-toolbar-left-row"></tr></tbody></table></td><td class="x-toolbar-right" align="right"><table cellspacing="0" class="x-toolbar-right-ct"><tbody><tr><td><table cellspacing="0"><tbody><tr class="x-toolbar-right-row"></tr></tbody></table></td><td><table cellspacing="0"><tbody><tr class="x-toolbar-extras-row"></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table>');
							this.leftTr = h
									.child("tr.x-toolbar-left-row", true);
							this.rightTr = h.child("tr.x-toolbar-right-row",
									true);
							this.extrasTr = h.child("tr.x-toolbar-extras-row",
									true)
						}
						var j = d.buttonAlign == "right" ? this.rightTr
								: this.leftTr, m = 0, k = d.items.items;
					...
					onRemove : function(a) {
						...
						Ext.layout.ToolbarLayout.superclass.onRemove.call(this,
								a)
					},
					destroy : function() {
...
(function() {
	...
	Ext.extend(a, Ext.Container, {
				...
				if (b.isFormField || b.render) {
					...
					if (b.tag) {
						...
						if (b.tagName) {
							...
							if (Ext.isObject(b)) {
								b = b.xtype ? this.createComponent(b) : this
										.constructButton(b)
							}
						}
					}
		...
		constructButton : function(d) {
			var c = d.events ? d : this.createComponent(d,
...
(function() {
	...
	Ext.PagingToolbar = Ext.extend(Ext.Toolbar, {
		...
		onLoad : function(b, e, k) {
			...
			this.cursor = (k.params && k.params[g.start]) ? k.params[g.start]
					: 0;
...
Ext.History = (function() {
	...
	function j(n) {
		var m = [ '<html><body><div id="state">',
				Ext.util.Format.htmlEncode(n), "</div></body></html>" ]
				.join("");
		try {
		...
		.extend(
				Ext.Panel,
				{
					...
					doAutoWidth : function(a) {
						...
						this
								.setWidth(b.constrain(this.minWidth,
										this.maxWidth));
		...
		.extend(
				Ext.Tip,
				{
					...
					initTarget : function(c) {
						...
						if ((a = Ext.get(c))) {
							if (this.target) {
								...
								this.mun(b, "mouseover", this.onTargetOver,
										this);
								this.mun(b, "mouseout", this.onTargetOut, this);
								this
										.mun(b, "mousemove", this.onMouseMove,
												this)
							}
							this.mon(a, {
					...
					getTargetXY : function() {
						...
						if (this.anchor) {
							this.targetCounter++;
							var c = this.getOffsets(), l = (this.anchorToTarget && !this.trackMouse) ? this.el
									.getAlignToXY(this.anchorTarget, this
											.getAnchorAlign())
									: this.targetXY, a = Ext.lib.Dom
									.getViewWidth() - 5, g = Ext.lib.Dom
									.getViewHeight() - 5, h = document.documentElement, e = document.body, k = (h.scrollLeft
									|| e.scrollLeft || 0) + 5, j = (h.scrollTop
									|| e.scrollTop || 0) + 5, b = [
									l[0] + c[0], l[1] + c[1] ];
							sz = this.getSize();
...
Ext.tree.TreePanel = Ext.extend(Ext.Panel, {
	...
	initComponent : function() {
		...
		this.addEvents("append", "remove", "movenode", "insert",
				...
				"containerclick", "checkchange", "beforedblclick", "dblclick",
				"containerdblclick", "contextmenu", "containercontextmenu",
...
Ext.tree.TreeNodeUI.prototype = {
	...
	renderElements : function(e, l, k, m) {
		this.indentMarkup = e.parentNode ? e.parentNode.ui.getChildIndent()
				: "";
		var g = Ext.isBoolean(l.checked), b, c = l.href ? l.href
				: Ext.isGecko ? "" : "#", d = [
	...
	updateExpandIcon : function() {
		if (this.rendered) {
			var g = this.node, d, c, a = g.isLast() ? "x-tree-elbow-end"
...
var swfobject = function() {
	var F = "undefined", t = "object", U = "Shockwave Flash", Y = "ShockwaveFlash.ShockwaveFlash", s = "application/x-shockwave-flash", T = "SWFObjectExprInst", z = "onreadystatechange", Q = window, l = document, v = navigator, V = false, W = [ j ], q = [], P = [], K = [], n, S, G, D, L = false, a = false, p, I, o = true, O = function() {
		var ac = typeof l.getElementById != F
				...
				.toLowerCase(), ag = aa ? /win/.test(aa) : /win/.test(aj), ae = aa ? /mac/
				.test(aa)
	...
	function N(aa) {
		...
		return Z && typeof encodeURIComponent != F ? encodeURIComponent(aa)
				: aa
	}
	var d = function() {
		if (O.ie && O.win) {
		...
		.extend(
				Ext.Container,
				{
					...
					show : function(b, c, a) {
						if (this.floating) {
							...
							this.showAt(this.el.getAlignToXY(b, c
									|| this.defaultAlign, this.defaultOffsets),
									a)
						} else {
					...
					onDestroy : function() {
						...
						var b = this.scroller;
						if (b) {
							Ext.destroy(b.topRepeater, b.bottomRepeater, b.top,
									b.bottom)
						}
				...
				Ext.form.Field,
				{
					...
					initEvents : function() {
						...
						if (this.selectOnFocus || this.emptyText) {
							this.mon(this.el, "mousedown", this.onMouseDown,
									this);
							if (this.emptyText) {
								this.applyEmptyText()
							}
		...
		.extend(
				Ext.form.TextField,
				{
					...
					onRender : function(b, a) {
						...
						if (this.grow) {
							this.textSizeEl = Ext.DomHelper.append(
									document.body, {
										tag : "pre",
					...
					autoSize : function() {
						...
						var c = this.el, a = Ext.util.Format
								.htmlEncode(c.dom.value), d = this.textSizeEl, b;
						...
						d.innerHTML = a;
						b = Math.min(this.growMax, Math.max(d.offsetHeight,
								this.growMin));
		...
		.extend(
				Ext.form.TriggerField,
				{
						...
						this.keyNav = new Ext.KeyNav(this.el, {
							...
							doRelay : function(c, b, a) {
								if (a == "down" || this.scope.isExpanded()) {
									var d = Ext.KeyNav.prototype.doRelay.apply(
											this, arguments);
									if (!Ext.isIE
											&& Ext.EventManager.useKeydown) {
					...
					restrictHeight : function() {
						...
						var b = this.innerList.dom, e = this.list
								.getFrameWidth("tb")
								+ (this.resizable ? this.handleHeight : 0)
								+ this.assetHeight, c = Math.max(
								b.clientHeight, b.offsetHeight, b.scrollHeight), a = this
								.getPosition()[1]
								- Ext.getBody().getScroll().top, g = Ext.lib.Dom
								.getViewHeight()
								- a - this.getSize().height, d = Math.max(a, g,
								this.minHeight || 0)
						...
						if (!a && this.forceSelection) {
							if (b.length > 0 && b != this.emptyText) {
								this.el.dom.value = Ext
										.isEmpty(this.lastSelectionText) ? ""
										: this.lastSelectionText;
								this.applyEmptyText()
							} else {
								this.clearValue()
		...
		.extend(
				Ext.form.Field,
				{
					...
					initValue : function() {
						if (this.value) {
							this.setValue
									.apply(this, this.buffered ? this.value
											: [ this.value ]);
					...
					beforeDestroy : function() {
						...
						Ext.form.CheckboxGroup.superclass.beforeDestroy
								.call(this)
					},
	...
	processRemove : function(b) {
		if (this.isField(b)) {
			...
			if (b.findBy) {
				...
				this.form.items.filterBy(a, this.form).each(this.form.remove,
						this.form)
			}
		}
	},
		...
		.extend(
				Ext.form.Field,
				{
					...
					createToolbar : function(e) {
						...
						function d(k, h, j) {
							return {
								...
								tooltip : a ? e.buttonTips[k] || undefined
										: undefined,
						...
						if (this.enableFontSize) {
							c.push("-", d("increasefontsize", false,
									this.adjustFont), d("decreasefontsize",
							...
							c
									.push(
											"-",
											{
												...
												clickEvent : "mousedown",
												tooltip : a ? e.buttonTips.forecolor || undefined
														: undefined,
												tabIndex : -1,
											...
											},
											{
												...
												clickEvent : "mousedown",
												tooltip : a ? e.buttonTips.backcolor || undefined
														: undefined,
												tabIndex : -1,
												menu : new Ext.menu.ColorMenu(
														{
						...
						if (this.enableAlignments) {
							c.push("-", d("justifyleft"), d("justifycenter"),
									d("justifyright"))
						}
						if (!Ext.isSafari2) {
							if (this.enableLinks) {
								c.push("-", d("createlink", false,
										this.createLink))
							}
							if (this.enableLists) {
								c.push("-", d("insertorderedlist"),
					...
					setReadOnly : function(c) {
						...
						Ext.form.HtmlEditor.superclass.setReadOnly
								.call(this, c)
					},
					...
					pushValue : function() {
						if (this.initialized) {
							...
							if (this.fireEvent("beforepush", this, a) !== false) {
								...
								if (Ext.isGecko) {
									var c = this.getDoc(), b = c.designMode
											.toLowerCase();
					...
					initEditor : function() {
						try {
							var c = this.getEditorBody(), a = this.el
									.getStyles("font-size", "font-family",
											"background-image",
											"background-repeat"), g, b;
							...
							if (Ext.isGecko) {
								Ext.EventManager.on(g, "keypress",
										this.applyCommand, this)
							}
							if (Ext.isIE || Ext.isWebKit || Ext.isOpera) {
								Ext.EventManager.on(g, "keydown", this.fixKeys,
										this)
							}
					...
					insertAtCursor : function(c) {
						...
						if (Ext.isIE) {
							this.win.focus();
							var b = this.getDoc(), a = b.selection
									.createRange();
							if (a) {
								a.pasteHTML(c);
								this.syncValue();
		...
		.extend(
				Ext.form.ComboBox,
				{
					...
					generateStore : function(b) {
						var c = this.minValue
								|| new Date(this.initDate).clearTime(), a = this.maxValue
					...
					setLimit : function(b, g, a) {
						...
						if (e) {
							...
							c.setHours(e.getHours(), e.getMinutes(),
									g ? 0 : 59, 0);
				...
				Ext.Panel,
				{
					...
					initComponent : function() {
						...
						this.addEvents("click", "dblclick", "contextmenu",
								...
								"headermousedown", "groupmousedown",
								"rowbodymousedown", "containermousedown",
								"cellclick", "celldblclick", "rowclick",
								"rowdblclick", "headerclick", "headerdblclick",
								"groupclick", "groupdblclick",
								"containerclick", "containerdblclick",
								"rowbodyclick", "rowbodydblclick",
								"rowcontextmenu", "cellcontextmenu",
								"headercontextmenu", "groupcontextmenu",
								"containercontextmenu", "rowbodycontextmenu",
								"bodyscroll", "columnresize", "columnmove",
								"sortchange", "reconfigure", "viewready")
					},
					onRender : function(d, a) {
					...
					applyState : function(a) {
						...
						if (a.sort && this.store) {
							this.store[this.store.remoteSort ? "setDefaultSort"
									: "sort"](a.sort.field, a.sort.direction)
						}
						var b = Ext.apply( {}, a);
						delete b.columns;
						delete b.sort;
					...
					processEvent : function(d, h) {
						this.fireEvent(d, h);
						var g = h.getTarget(), c = this.view, k = c
								.findHeaderIndex(g);
						if (k !== false) {
...
Ext.grid.GridView = Ext
		.extend(
				Ext.util.Observable,
				{
					...
					constructor : function(a) {
						Ext.apply(this, a);
						this.addEvents("beforerowremoved",
								"beforerowsinserted", "beforerefresh",
								"rowremoved", "rowsinserted", "rowupdated",
								"refresh");
					...
					doRender : function(g, k, s, a, q, w) {
						...
						for ( var v = 0, y = k.length; v < y; v++) {
							...
							for ( var x = 0; x < q; x++) {
								...
								u.attr = u.cellAttr = "";
								u.value = A.renderer.call(A.scope,
										o.data[A.name], u, o, n, x, s);
								u.style = A.style;
					...
					getOffsetWidth : function() {
						return (this.cm.getTotalWidth() + this
								.getScrollOffset())
								+ "px"
					},
					getScrollOffset : function() {
						return Ext.num(this.scrollOffset, Ext
								.getScrollBarWidth())
					},
					...
					ensureVisible : function(u, g, e) {
						...
						var r = t + l.offsetHeight, a = o.clientHeight, n = q
								+ a;
						if (t < q) {
							o.scrollTop = t
						} else {
					...
					insertRows : function(a, j, e, h) {
						...
						if (!h && j === 0 && e >= d) {
							...
							if (!h) {
								...
								if (j === 0 || j >= d) {
									Ext.fly(this.getRow(j)).addClass(
											j === 0 ? this.firstRowCls
													: this.lastRowCls)
								}
							}
						}
						...
						if (!this.userResized && j.autoExpandColumn) {
							...
							if (d != k) {
								...
								var c = Math.min(Math.max(((k - d) + e),
										j.autoExpandMin), j.autoExpandMax);
								if (c != e) {
					...
					getColumnData : function() {
						...
						for ( var c = 0; c < e; c++) {
							...
							d[c] = {
								name : (!Ext.isDefined(b) ? this.ds.fields
										.get(c).name : b),
					...
					handleHdMenuClick : function(c) {
						var b = this.hdCtxIndex, a = this.cm, d = this.ds, e = c
								.getItemId();
						switch (e) {
						case "asc":
						...
						if (h && !this.headersDisabled) {
							...
							if (this.grid.enableColumnResize !== false) {
								if (a - g.left <= b
									...
									if (g.right - a <= (!this.activeHdBtn ? b
											: 2)
											&& this.cm
...
Ext.grid.HeaderDropZone = Ext.extend(Ext.dd.DropZone, {
	...
	onNodeDrop : function(b, o, g, c) {
		...
		if (d != b) {
			...
			var p = (a.right - k) <= ((a.right - a.left) / 2) ? "after"
					: "before";
...
Ext.grid.GridView.ColumnDragZone = Ext.extend(Ext.grid.HeaderDragZone, {
	constructor : function(a, b) {
		Ext.grid.GridView.ColumnDragZone.superclass.constructor.call(this, a,
				b, null);
		...
		.extend(
				Ext.util.Observable,
				{
					...
					constructor : function(a) {
						...
						this.addEvents("widthchange", "headerchange",
								"hiddenchange", "columnmoved", "configchange");
					...
					setConfig : function(d, b) {
						...
						for (e = 0, a = d.length; e < a; e++) {
							...
							if (!h.isColumn) {
								var g = Ext.grid.Column.types[h.xtype
										|| "gridcolumn"];
								h = new g(h);
								d[e] = h
							}
...
Ext.grid.RowSelectionModel = Ext
		.extend(
				Ext.grid.AbstractSelectionModel,
				{
					...
					constructor : function(a) {
						...
						this.addEvents("selectionchange", "beforerowselect",
								"rowselect", "rowdeselect");
						Ext.grid.RowSelectionModel.superclass.constructor
								.call(this)
					},
					initEvents : function() {
						if (!this.grid.enableDragDrop && !this.grid.enableDrag) {
							this.grid.on("rowmousedown", this.handleMouseDown,
									this)
						}
					...
					selectRow : function(b, d, a) {
						...
						if (c
								&& this.fireEvent("beforerowselect", this, b,
										d, c) !== false) {
					...
					destroy : function() {
						...
						Ext.grid.RowSelectionModel.superclass.destroy
								.call(this)
					}
				});
...
Ext.grid.TemplateColumn = Ext.extend(Ext.grid.Column, {
	constructor : function(a) {
		...
		var b = (!Ext.isPrimitive(this.tpl) && this.tpl.compile) ? this.tpl
...
Ext.grid.CellSelectionModel = Ext
		.extend(
				Ext.grid.AbstractSelectionModel,
				{
					constructor : function(a) {
						Ext.apply(this, a);
						this.selection = null;
						this.addEvents("beforecellselect", "cellselect",
								"selectionchange");
						Ext.grid.CellSelectionModel.superclass.constructor
								.call(this)
					},
					initEvents : function() {
						this.grid.on("cellmousedown", this.handleMouseDown,
								this);
						this.grid.on(Ext.EventManager.useKeydown ? "keydown"
					...
					clearSelections : function(b) {
						...
						if (a) {
							if (b !== true) {
								this.grid.view.onCellDeselect(a.cell[0],
										a.cell[1])
							}
							this.selection = null;
							this.fireEvent("selectionchange", this, null)
					...
					handleKeyDown : function(l) {
						...
						var d = l.getKey(), j = this.grid, q = this.selection, b = this, n = function(
							...
							return j.walkCells(g, c, e,
									j.isEditor && j.editing ? b.acceptsNav
											: b.isSelectable, b)
						}, p, h, a, m, o;
						switch (d) {
						case l.ESC:
...
Ext.grid.EditorGridPanel = Ext
		.extend(
				Ext.grid.GridPanel,
				{
					...
					initComponent : function() {
						Ext.grid.EditorGridPanel.superclass.initComponent
								.call(this);
						if (!this.selModel) {
							this.selModel = new Ext.grid.CellSelectionModel()
						}
						this.activeEditor = null;
						this.addEvents("beforeedit", "afteredit",
								"validateedit")
					},
					initEvents : function() {
						Ext.grid.EditorGridPanel.superclass.initEvents
								.call(this);
						this.getGridEl()
								.on(
										"mousewheel",
										this.stopEditing.createDelegate(this,
												[ true ]), this);
						this.on("columnresize", this.stopEditing, this,
								[ true ]);
					...
					onResize : function() {
						Ext.grid.EditorGridPanel.superclass.onResize.apply(
								this, arguments);
					...
					onAutoEditClick : function(c, b) {
						...
						var g = this.view.findRowIndex(b), a = this.view
								.findCellIndex(b);
						if (g !== false && a !== false) {
							this.stopEditing();
					...
					startEditing : function(j, c) {
						...
						if (this.colModel.isCellEditable(c, j)) {
							...
							var d = this.store.getAt(j), h = this.colModel
									.getDataIndex(c), g = {
								grid : this,
								record : d,
								field : h,
							...
							if (this.fireEvent("beforeedit", g) !== false
									&& !g.cancel) {
								this.editing = true;
								...
								b.startEdit(this.view.getCell(j, c).firstChild,
										Ext.isDefined(a) ? a : "")
							}
						}
					},
				...
				Ext.grid.GridView,
				{
					...
					processEvent : function(b, h) {
						...
						if (g) {
							...
							if (a) {
								this.grid.fireEvent("group" + b, this.grid, d,
										a, h)
							}
						}
					},
					...
					doRender : function(c, h, q, a, p, s) {
						...
						var z = this.getGroupField(), o = this.cm
								.findColumnIndex(z), w;
						this.enableGrouping = (this.enableGrouping === false) ? false
								: !!z;
						...
						var j = "width:" + this.getTotalWidth() + ";", e = this.cm.config[o], b = e.groupRenderer
								|| e.renderer, t = this.showGroupName ? (e.groupName || e.header)
								+ ": "
								: "", y = [], l, u, v, n;
						for (u = 0, v = h.length; u < v; u++) {
							...
							if (!l || l.group != w) {
								...
								this.state[n] = !(Ext.isDefined(this.state[n]) ? !this.state[n]
										: this.startCollapsed);
								l = {
									group : w,
									gvalue : d,
						...
						for (u = 0, v = y.length; u < v; u++) {
							...
							x[x.length] = Ext.grid.GroupingView.superclass.doRender
									.call(this, c, w.rs, q, w.startRow, p, s);
					...
					getGroupId : function(a) {
						...
						return this.constructId(a, b, this.cm
								.findColumnIndex(b))
					},
					constructId : function(c, e, a) {
						var b = this.cm.config[a], d = b.groupRenderer
								|| b.renderer, g = (this.groupMode == "value") ? c
								: this.getGroup(c, {
									data : {}
								}, d, 0, a, this.ds);
